...
const HomePage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const { data: postData, error: postError } = await supabase
                ...
                .limit(4); // Fetch 4 to get 1 featured and 3 others

            // Fetch upcoming 3 programs
    ...
    return (
        <div className="overflow-x-hidden">
            {/* Hero Section */}
            <section className="relative bg-blue-600 text-white py-20 md:py-32 bg-cover bg-center" style={{ backgroundImage: "url('https://picsum.photos/seed/school/1600/900')" }}>
                 <div className="absolute inset-0 bg-black opacity-50"></div>
                 <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <h1 className="text-4xl md:text-6xl font-extrabold leading-tight animate-fade-in-down">Selamat Datang di Website OSIS</h1>
                    <p className="mt-4 text-lg md:text-xl max-w-3xl mx-auto animate-fade-in-up delay-200">SMK LPPMRI 2 KEDUNGREJA</p>
                    <p className="mt-2 text-md md:text-lg max-w-3xl mx-auto animate-fade-in-up delay-300">Mewujudkan Siswa yang Kreatif, Inovatif, dan Berkarakter.</p>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Fokus Utama Kami</h2>
                    <div className="grid md:grid-cols-3 gap-10 text-center">
                        <div className="p-6">
                            <div className="text-blue-500 mb-4">
                                <i className="fas fa-lightbulb fa-3x"></i>
                            </div>
                            <h3 className="text-xl font-semibold mb-2">Kreativitas & Inovasi</h3>
                            <p className="text-gray-600">Mendorong dan mewadahi ide-ide kreatif serta inovasi dari seluruh siswa.</p>
                        </div>
                        <div className="p-6">
                            <div className="text-green-500 mb-4">
                                <i className="fas fa-users fa-3x"></i>
                            </div>
                            <h3 className="text-xl font-semibold mb-2">Kepemimpinan & Organisasi</h3>
                            <p className="text-gray-600">Melatih jiwa kepemimpinan dan kemampuan berorganisasi untuk masa depan.</p>
                        </div>
                        <div className="p-6">
                             <div className="text-purple-500 mb-4">
                                <i className="fas fa-heart fa-3x"></i>
                            </div>
                            <h3 className="text-xl font-semibold mb-2">Sosial & Kepedulian</h3>
                            <p className="text-gray-600">Menumbuhkan rasa kepedulian terhadap sesama dan lingkungan sekitar.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 bg-blue-600 text-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-center mb-10">Kata Mereka</h2>
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        <div className="bg-white/20 p-6 rounded-lg">
                            <p className="italic">"OSIS di sini sangat aktif dan selalu punya program menarik. Saya jadi lebih semangat ke sekolah!"</p>
                            <p className="mt-4 font-semibold">- Budi, Siswa Kelas XI</p>
                        </div>
                         <div className="bg-white/20 p-6 rounded-lg">
                            <p className="italic">"Kegiatan yang diadakan OSIS sangat membantu siswa mengembangkan soft skill di luar jam pelajaran."</p>
                            <p className="mt-4 font-semibold">- Ibu Siti, Guru Bahasa Indonesia</p>
                        </div>
                    </div>
                </div>
            </section>
